...
所有數值均使用 `--reeval` 修正評估邏輯（中文數字正規化 + 同義詞比對），繁問繁答、繁問簡答、簡問簡答三種 variant 使用相同評估標準。

| 模型 | 架構 | 繁問繁答 | @130K | 繁問簡答 | 簡問簡答 | @130K | Tokenizer Overhead |
|------|------|---------|-------|---------|---------|--------|-------------------|
| gemma4:31b | Dense 31B | **100.0%** | **100.0%** | — | 100.0% | 100.0% | +5.7% |
| qwen3.5:35b | Dense 35B | **100.0%** | **100.0%** | — | 100.0% | 100.0% | +10.3% |
| qwen3.5:27b | Dense 27B | **100.0%** | **100.0%** | — | 99.9% | 100.0% | +10.3% |
| qwen3.5:9b | Dense 9B | **100.0%** | **100.0%** | — | 100.0% | 100.0% | +10.3% |
| qwen3.5:4b | Dense 4B | **100.0%** | **100.0%** | — | 100.0% | 100.0% | +10.3% |
| gemma4:e4b | MoE 4B/16B | 99.9% | **100.0%** | — | 99.9% | 100.0% | +5.7% |
| gemma4:e2b | MoE 2B/8B | 99.8% | **100.0%** | — | 100.0% | 100.0% | +5.7% |
| qwen3.5:2b | Dense 2B | 99.8% | 99.1% | — | 100.0% | 100.0% | +10.3% |
| gemma4:26b | Dense 26B | 98.9% | 92.7% | — | 99.7% | 97.3% | +5.7% |
| gemma3:12b | Dense 12B | 98.0% | 86.4% | — | 97.9% | 86.4% | +5.7% |
| llama3.3:70b | Dense 70B | 97.9% | 80.9% | — | 100.0%‡ | —‡ | +7.1% |
| llama3.1:8b | Dense 8B | 97.1% | 91.8% | **98.8%** | 97.1% | 82.7% | +7.1% |
| qwen3:8b | Dense 8B | 94.1%（≤65K）| —（超限）| — | — | — | — |
| gemma3:4b | Dense 4B | 91.6% | 52.7% | **99.1%** | 92.0% | 52.7% | +5.7% |
| gemma3:27b | Dense 27B | 85.0%（★） | 0.0%（★）| — | 90.5% | 0.9% | +5.7% |
| gemma3:1b | Dense 1B | 76.4%（≤32K）| — | — | 82.7%（≤32K）| — | +5.7% |

★ gemma3:27b 在 100K+ 輸出退化為 `<pad>` token，非正常 context rot，數值不代表理解能力。
‡ llama3.3:70b 簡問簡答僅完成 502 筆（≤6K 字元），不具代表性。
...
| LLaMA3 | llama3.1:8b, 3.3:70b | 1.072–1.074 | **+7.2–7.4%** |
