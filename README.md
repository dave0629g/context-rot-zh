...
繁體中文因 BPE tokenizer 碎片化（同一段文字比簡體多用 5.7–13.5% 的 tokens，依 tokenizer 家族而異），是否影響 LLM 在長 context 下的資訊檢索能力？本研究以三個可操作化的 RQ 進行系統性驗證：

- **RQ1**：在繁體中文長文本情境下，控制架構類型後，分詞器家族與參數規模對 context rot 起始點與退化速率的相對解釋力為何？
- **RQ2**：控制語義與句法條件下，繁／簡體中文之間的 token 計數差異，是否為繁體中文 context rot 加速的獨立因素？
- **RQ3**：繁體書寫系統造成的 token overhead（每字符所需 token 數的系統性增量），在不同分詞器家族中使 context rot 起始點提前多少 token？
...
全部 17 個模型、三 variant 已完成，共 **65,670 筆**有效記錄（含跳過筆數）。

| 模型 | 大小 | 繁問繁答 | 繁問簡答 | 簡問簡答 | 備註 |
|------|------|---------|---------|---------|------|
| gemma3:1b | 1B | 990 筆 ✓ | 990 筆 ✓ | 990 筆 ✓ | 65K–130K 因 ctx 超限跳過（330 筆 skipped） |
| gemma3:4b | 4B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | |
| gemma3:12b | 12B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | |
| gemma3:27b | 27B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | 100K/130K 繁問繁答輸出 pad token（模型異常） |
| gemma4:e2b | E2B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | |
| gemma4:e4b | E4B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | |
| gemma4:26b | 26B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | |
| gemma4:31b | 31B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | |
| llama3.1:8b | 8B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | |
| llama3.1:70b | 70B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | |
| llama3.3:70b | 70B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | |
| qwen3:8b | 8B | 1,100 筆 ✓ | 1,100 筆 ✓ | 1,100 筆 ✓ | 65K–130K 因 ctx 超限跳過（220 筆 skipped） |
| qwen3.5:2b | 2B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | |
| qwen3.5:4b | 4B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | |
| qwen3.5:9b | 9B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | |
| qwen3.5:27b | 27B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | |
| qwen3.5:35b | 35B | 1,320 筆 ✓ | 1,320 筆 ✓ | 1,320 筆 ✓ | |
...
所有數值均使用 `--reeval` 修正評估邏輯，三種 variant 採相同評估標準。@130K 欄位為繁問繁答與簡問簡答各自在 130,000 字元長度的單點準確率。

| 模型 | 架構 | 繁問繁答 | 繁問簡答 | 簡問簡答 | @130K(繁) | @130K(簡答) | Tokenizer Overhead |
|------|------|---------|---------|---------|-----------|-------------|-------------------|
| gemma4:31b | Dense 31B | **100.0%** | **100.0%** | **100.0%** | **100.0%** | **100.0%** | +5.7% |
| qwen3.5:9b | Dense 9B | **100.0%** | **100.0%** | **100.0%** | **100.0%** | **100.0%** | +10.1% |
| qwen3.5:4b | Dense 4B | **100.0%** | **100.0%** | **100.0%** | **100.0%** | **100.0%** | +10.1% |
| qwen3.5:35b | Dense 35B | **100.0%** | **100.0%** | **100.0%** | **100.0%** | **100.0%** | +10.1% |
| qwen3.5:27b | Dense 27B | **100.0%** | 99.9% | 99.9% | **100.0%** | **100.0%** | +10.1% |
| gemma4:e4b | MoE 4B/16B | 99.9% | 99.9% | 99.9% | **100.0%** | **100.0%** | +5.7% |
| gemma4:e2b | MoE 2B/8B | 99.8% | 99.9% | **100.0%** | **100.0%** | **100.0%** | +5.7% |
| qwen3.5:2b | Dense 2B | 99.8% | **100.0%** | **100.0%** | 99.1% | **100.0%** | +10.1% |
| gemma4:26b | MoE 26B | 98.9% | 99.8% | 99.7% | 92.7% | 97.3% | +5.7% |
| gemma3:12b | Dense 12B | 98.0% | 97.2% | 97.9% | 86.4% | 86.4% | +5.7% |
| llama3.3:70b | Dense 70B | 97.9% | 98.7% | 98.8% | 80.9% | 87.3% | +7.1% |
| llama3.1:8b | Dense 8B | 97.1% | 97.1% | 97.1% | 91.8% | 82.7% | +7.1% |
| llama3.1:70b | Dense 70B | 96.9% | 97.8% | 98.5% | 71.8% | 84.5% | +7.1% |
| qwen3:8b | Dense 8B | 94.1%（≤65K）| 94.5%（≤65K）| 94.4%（≤65K）| —（超限）| —（超限）| +13.5% |
| gemma3:4b | Dense 4B | 91.6% | 93.2% | 92.0% | 52.7% | 52.7% | +5.7% |
| gemma3:27b | Dense 27B | 85.0%（★）| 90.4%（★）| 90.5%（★）| 0.0%（★）| 0.9%（★）| +5.7% |
| gemma3:1b | Dense 1B | 76.4%（≤32K）| 78.7%（≤32K）| 82.7%（≤32K）| —（超限）| —（超限）| +5.7% |

★ gemma3:27b 在 100K+ 輸出退化為 `<pad>` token，非正常 context rot，數值不代表理解能力。
...
| 長度 | 繁問繁答 | 繁問簡答 | 簡問簡答 |
|------|---------|---------|---------|
| 500–12K | 100.0% | 100.0% | 100.0% |
| 16K | 99.1% | 100.0% | 100.0% |
| 24K–32K | 100.0% | 100.0% | 100.0% |
| 65K | 96.4% | 95.5% | 95.5% |
| 100K | 93.6% | 90.0% | 92.7% |
| 130K | 86.4% | 80.9% | 86.4% |
...
| 32K | 100.0% | 100.0% | 100.0% |
| 65K | 97.3% | 96.4% | 98.2% |
| 100K | 97.3% | 99.1% | 100.0% |
| 130K | 80.9% | 90.0% | 87.3% |
...
| 長度 | 繁問繁答 | 繁問簡答 | 簡問簡答 |
|------|---------|---------|---------|
| 500 | 97.3% | 100.0% | 100.0% |
| 2K | 99.1% | 100.0% | 100.0% |
| 4K–65K | 100.0% | 100.0% | 100.0% |
| 100K | 94.5% | 95.5% | 97.3% |
| 130K | 71.8% | 78.2% | 84.5% |

> llama3.1:70b 在 ≤65K 幾乎全部 100%，但 130K 繁問繁答跌至 71.8%，簡問簡答 84.5%，顯示簡體 context 對長距離檢索有明顯幫助（+12.7pp）。
...
6. **llama 系列長 context 行為比較（三 variant 全完成）**
   - llama3.3:70b：130K 繁問繁答 80.9%，繁問簡答 90.0%（+9.1pp），簡問簡答 87.3%
   - llama3.1:8b：130K 三 variant 差異小（繁 91.8%、簡 84.5%、簡答 82.7%），整體更穩健
   - llama3.1:70b：130K 繁問繁答 71.8%，簡問簡答 84.5%（+12.7pp），70B 反而比 8B 在 130K 更受繁體碎片化影響
   - 共同特徵：500–65K 接近全對，100K–130K 才開始退化（典型「漸進型 context rot」）

---

## 量化分析（全模型數據，2026-05-04）

### 方法論說明：評估一致性

所有三種 variant（繁問繁答、繁問簡答、簡問簡答）均透過 `04_analyze.py --reeval` 重新評估，套用相同的中文數字正規化與同義詞比對邏輯。`04_analyze.py` 會自動載入對應的 `h2_` 結果檔案並一併 reeval，三種 variant 的評估標準一致。

校正幅度參考：以 gemma3:4b 為例，trad 在 65K 的原始準確率約 73.6%，reeval 後為 88.2%（差距約 14.6pp）；simp_q 在 65K 的原始準確率 82.7%，reeval 後為 92.7%（差距約 10pp）。

---

### 一、實測 Token Overhead（繁體輸入 vs 簡體輸入）

在大 context（≥65K 字元）下，整體 prompt token 數的繁/簡比值趨於穩定，反映各 tokenizer 家族的真實開銷：

| Tokenizer 家族 | 代表模型 | 穩定比值 T/SQ | 繁體 Overhead |
|---------------|---------|-------------|-------------|
| Gemma3/4 | gemma3:4b 等 | 1.059–1.061 | **+5.9–6.1%** |
| LLaMA3 | llama3.1:8b, 3.1:70b, 3.3:70b | 1.072–1.074 | **+7.2–7.4%** |
| Qwen3.5 | qwen3.5:2b–35b | 1.103–1.106 | **+10.3–10.6%** |
| Qwen3 | qwen3:8b | 1.135 | **+13.5%** |

實測值與實驗設計中引用的 14.5% 有顯著落差。14.5% 很可能為純文字（不含 prompt template）的字符層級估算，而非完整 prompt 的 token 計數。以上數字基於實際送入模型的完整 prompt，為本實驗的有效基準。

**(A)** 可直接從數據推論。

---

### 二、語境腐化起始點（繁問繁答，reeval）

起始點定義：準確率連續兩個 context 長度 < 95%，或單點 < 80%。

| 模型 | 起始字元數 | 起始 Token 數 | 起始點準確率 | 宣稱 ctx（tokens）| 有效利用率 |
|------|----------|-------------|------------|-----------------|----------|
| gemma3:1b | 6,000 | 4,661 | 90.0% | 128K | 3.6% |
| gemma3:4b | 65,000 | 49,323 | 88.2% | 128K | 38.5% |
| gemma3:27b | 100,000 ★ | 75,384 ★ | 20.9% ★ | 128K | 58.9% |
| gemma3:12b | 100,000 | 75,847 | 93.6% | 128K | 59.3% |
| llama3.1:8b | 65,000 | 57,583 | 92.7% | 131K | 43.9% |
| llama3.3:70b | 無（＞130K）| — | 80.9% @130K | 131K | — |
| Gemma4 全系列 | 無（＞130K）| — | ≥91.8% @130K | 131K | — |
| Qwen3.5 全系列 | 無（＞130K）| — | ≥99.1% @130K | 131K | — |

★ gemma3:27b 的「起始點」是 pad token 輸出退化，非逐漸 context rot。

宣稱 128K/131K 的模型中，**有腐化的模型最早在宣稱容量的 3.6%（gemma3:1b）即開始退化**。即使是相對穩健的 llama3.1:8b，起始點 57,583 tokens 也只佔宣稱 131K 的 43.9%。

**(A)** 可直接從數據推論。

---

### 三、語境腐化係數（繁問繁答，reeval）

對準確率 < 0.98 的降解區間進行線性迴歸，斜率即為每 1,000 token 損失的準確率百分點（pp）：

| 模型 | 斜率（pp/1k tok）| R² | 每損失 1pp 需 token | 降解區間 |
|------|----------------|----|--------------------|---------|
| gemma3:1b | **−3.63 pp** | 0.960 | **275** | 1,608–24,368 |
| gemma3:4b | −0.51 pp | 0.952 | 1,961 | 12,247–98,560 |
| gemma3:12b | −0.20 pp | 0.911 | 5,000 | 49,323–98,560 |
| llama3.3:70b | −0.28 pp | 0.713 | 3,571 | 57,583–115,086 |

注：llama3.1:8b 與 gemma3:27b 降解區間內資料點不足（前者含大量 ~100% 高值點，後者是 pad token），無法可靠迴歸。Gemma4 與 Qwen3.5 無腐化現象，不適用。

關鍵觀察：
- **gemma3:1b 腐化速率是 gemma3:4b 的 7.1 倍**（275 vs 1,961 tokens/pp），但 4B 的腐化速率也高於 12B（1,961 vs 5,000），顯示 Gemma3 家族中體積越大腐化越慢——直到 27B 例外（受 pad token 問題干擾）。
- llama3.3:70b（3,571 tokens/pp）降解比 gemma3:4b（1,961 tokens/pp）緩慢，但 70B 的起始點更早（見 Q1）。

**(A)** 可直接從數據推論；gemma3:27b 的係數 **(C)** 無法計算（受 pad token 污染）。

---

### 四、架構與參數量的影響

#### Gemma3 Dense：大模型不等於更好

| 模型 | 繁問繁答整體 | @130K | 起始點 |
|------|------------|-------|-------|
| gemma3:1b（1B）| 76.4% | — | 6K chars |
| gemma3:4b（4B）| 91.6% | 52.7% | 65K chars |
| gemma3:12b（12B）| 98.0% | 86.4% | 100K chars |
| gemma3:27b（27B）| 85.0%★ | 0.0%★ | 100K★ |

**Gemma3 呈非單調性**：27B（85.0%）整體準確率低於 12B（98.0%），甚至低於 4B（91.6%）。在 130K 字元下，27B 完全失效（pad token），12B 維持 86.4%，4B 為 52.7%。純參數量不能預測 Gemma3 系列的 context rot 抗性。

#### LLaMA3：70B 遜於 8B

| 模型 | 繁問繁答整體 | @130K | 起始點 | rot coeff |
|------|------------|-------|-------|-----------|
| llama3.1:8b（8B）| 97.1% | 91.8% | 65K chars | 不顯著 |
| llama3.3:70b（70B）| 97.9% | 80.9% | ＞130K | −0.28 pp/1k |

**llama3.3:70B 在 130K 的準確率（80.9%）低於 llama3.1:8B（91.8%）**，差距 11.1pp。rot coefficient 70B = −0.28 pp/1k tok，8B 降解不顯著。這是本數據集中最反直覺的 scaling 現象。

#### Gemma4 MoE vs Dense

| 模型 | 活躍參數 | 總參數 | 繁問繁答整體 | @130K |
|------|---------|-------|------------|-------|
| gemma4:e2b | **2B** | 8B | 99.8% | **100.0%** |
| gemma4:e4b | **4B** | 16B | 99.9% | **100.0%** |
| gemma4:26b | 26B | 26B | 98.9% | 91.8% |
| gemma4:31b | 31B | 31B | **100.0%** | **100.0%** |

gemma4:e2b（2B active）在 130K 字元下準確率 100%，媲美 gemma4:31B Dense。**活躍參數量（2B）比總參數量（8B）更具預測力**。對比 gemma3:4B Dense（活躍 4B）的 52.7% @130K，Gemma4 MoE 架構的效能增益幅度達 47pp。

#### Qwen3.5 全系列免疫

5 個 Qwen3.5 模型（2B–35B）在繁體中文測試中全部達到 ≥99.8% 整體準確率，130K 字元下最低為 99.1%（qwen3.5:2B）。無論模型大小，表現差距 < 1%，與同規模的 Gemma3、LLaMA 形成量級差距。

**(A)** 所有架構比較可直接從數據推論。**(B)** MoE 優勢的機制（路由策略與長序列 attention）需消融實驗確認。

---

### 五、宣稱 Context Window vs 實際有效使用率

各模型宣稱 128K 或 131K tokens，但實測最大 prompt token 數（130K 字元）遠低於宣稱值：

| 模型 | 宣稱 ctx | 最大測試 prompt tokens | 利用率 | @最大測試點的 trad 準確率 |
|------|---------|----------------------|------|------------------------|
| Gemma3/4 | 128K | 98,560 | 77% | 0.0–100.0%（模型差異大）|
| LLaMA3 | 131K | 115,086 | 88% | 80.9–91.8% |
| Qwen3.5 | 131K | 90,232 | 69% | 99.1–100.0% |
| qwen3:8b | 40K | 40,960 | ~102% | 38.2%（溢出）|

在 77% 利用率（98,560 tokens）下，gemma3:12B 仍維持 86.4%，gemma3:4B 已降至 52.7%，gemma3:27B 完全失效（pad token）。**宣稱 128K 的模型在 77% 利用率時已出現從優到劣的全部表現分布**，「宣稱 context window = 可靠使用範圍」的假設不成立。

繁體輸入的額外影響：在相同字元長度下，繁體比簡體多消耗 5.7–10.3% token，等效壓縮了可靠使用範圍。若模型在 X tokens 開始腐化，繁體輸入觸發腐化所對應的字元數為 X / 1.059–1.106（即更短的文章長度）。

**(A)** 利用率數字可直接計算；**(B)** 繁體對有效 context 的「等效壓縮」量在 simp_q reeval 修復後可精確量化。
...
| # | 現象 | 量化差距 | 類別 |
|---|------|---------|------|
| 1 | Qwen3.5 全系列對 context rot 完全免疫（2B–35B）| qwen3.5:2B @130K=99.1% vs gemma3:4B @130K=52.7%（差距 46.4pp，同參數規模）| (A) |
| 2 | llama3.3:70B @130K（80.9%）遜於 llama3.1:8B（91.8%）| 差距 11.1pp，70B rot coeff 比 8B 快 | (A) |
| 3 | gemma3:27B 整體（85.0%）低於 gemma3:12B（98.0%）及 4B（91.6%）| 差距分別 13pp 及 6.6pp；27B @130K=0% vs 12B @130K=86.4% | (A)★ |
| 4 | gemma4:e2b（2B active）@130K=100%，等同 gemma4:31B Dense | 在相同 active params 下，MoE vs Dense 差距 0%；同 active params 的 gemma3:4B（Dense）差距 47.3pp | (A) |
| 5 | qwen3:8b 在 65K 字元出現硬崖（100%→38.2%）| 65K 字元≈40,960 tokens，恰好超過宣稱 context window；非漸進 context rot | (A) |
| 6 | gemma3:4B 繁問簡答（reeval）= 99.1%，高於繁問繁答（reeval）= 91.6%（+7.5pp）| 使用簡體 context + 繁體問題顯著提升準確率；機制待釐清 | (A)/(B) |

★ 異常 3 部分受 pad token 輸出干擾（100K/130K），但 gemma3:27B 整體數值已包含 65K 以前的正常數據，整體低於 12B 的現象仍成立。
...
| 項目 | 影響 | 優先級 |
|------|------|-------|
| ~~修復 `04_analyze.py` 對 `simplified_q` variant 的 --reeval 支援~~ | ~~所有繁/簡比較結論的可信度~~ | ✅ 已完成 |
| ~~llama3.3:70b simp_q 補完~~ | ~~70B 的繁/簡比較~~ | ✅ 已完成（1,320 筆）|
| ~~所有模型三 variant 補完~~ | ~~RQ2/RQ3 分析基礎~~ | ✅ 已完成（17 模型全三 variant）|
| 調查 130K 反轉機制（gemma3:4b / llama3.1:8b 等）| RQ2 非單調效應的解釋 | **高** |
| 200K+ 字元實驗（Gemma4 / Qwen3.5）| 克服天花板效應，RQ3 更多數據點 | 高 |
| gemma3:1b 補足 65K+ 數據（目前因 ctx 超限跳過）| 1B 模型的完整 context rot 曲線 | 低 |
...
17 個模型三種 variant（繁問繁答、繁問簡答、簡問簡答）均已完成並套用 reeval（評估標準一致），共 65,670 筆有效記錄。本章節就三個核心研究問題和探索性分析提出正式答覆。

---

### RQ1：控制架構類型後，分詞器家族與參數規模對 context rot 起始點與退化速率的相對解釋力為何？

**分析框架**：以「行為模式」（模式 A–D，詳後節）為架構控制，在同模式內比較 tokenizer 家族與參數規模的預測力。onset 定義為準確率首次穩定低於 95%（連續兩點）或單點低於 80% 的 context 字元長度；rate 以退化區間的線性迴歸斜率（pp/1K chars）量化。

#### 同家族內：參數規模的解釋力（控制 tokenizer + 架構代際）

**Gemma3（tokenizer +5.7%，dense，同代際）**：

| 模型 | 繁問繁答 Onset | @65K | @100K | @130K | 退化斜率（pp/1K chars）|
|------|-------------|------|-------|-------|----------------------|
| gemma3:1b | ~6K chars | — | — | — | −2.66（硬截斷型）|
| gemma3:4b | ~65K chars | 88.2% | 68.2% | 52.7% | −0.35 |
| gemma3:12b | ~65K chars | 96.4% | 93.6% | 86.4% | −0.09 |
| gemma3:27b | ~65K chars | 99.1% | 20.9%（★）| 0.0%（★）| N/A（pad bug）|

→ 同家族內，參數規模對 onset 無顯著影響（4B/12B/27B 均在 65K 附近開始退化），但對退化速率有顯著影響：4B 斜率為 12B 的 3.9 倍，表示規模主要影響 **率（rate）** 而非 **起始點（onset）**。

**Llama（tokenizer +7.1%，dense，跨版本）**：

| 模型 | Onset | @65K | @100K | @130K |
|------|-------|------|-------|-------|
| llama3.1:8b | ~65K | 92.7% | 90.9% | 91.8% |
| llama3.1:70b | ~100K | 100.0% | 94.5% | 71.8% |
| llama3.3:70b | ~100K | 97.3% | 97.3% | 80.9% |

→ 8B → 70B 的 onset 推遲（65K → 100K），規模對 onset 有效果；兩個 70B 版本（3.1 vs 3.3）在 onset 相近但 130K 差異不大，架構版本的影響小於參數量。

**Qwen3.5（tokenizer +10.1%，dense）**：

| 模型 | 整體 | @130K |
|------|------|-------|
| 2B / 4B / 9B / 27B / 35B | ≥99.8% | ≥99.1% |

→ 全系列模式 D（天花板效應），參數規模在此家族內對 onset/rate 均無可觀察效果——訓練資料品質與架構設計完全掩蓋規模差異。

#### 跨家族：tokenizer 家族 + 架構代際的複合效應

| Tokenizer 家族 | Token Overhead | 典型 130K 表現（Mode B 模型）| 解釋 |
|---------------|--------------|--------------------------|------|
| Gemma（Gemma3）| +5.7% | 52.7%（4B）/ 86.4%（12B）| 退化最嚴重；但 overhead 最低 |
| Llama | +7.1% | 71.8%–91.8% | 中等退化 |
| Qwen3.5 | +10.1% | ≥99.1% | 近乎完美；overhead 最高 |

→ **tokenizer overhead 與退化嚴重程度呈負相關**（overhead 越高反而退化越輕），直接反駁「overhead 驅動 rot」的簡單因果。架構代際與訓練資料分布的解釋力壓倒 tokenizer 家族效應。

**RQ1 答覆**：在架構類型相同的條件下，參數規模主要影響退化速率（rate）而非起始點（onset）；起始點更多受訓練分布與 context 壓縮效率決定。跨家族比較中，tokenizer 家族的 overhead 差異無法獨立預測退化，架構代際（Gemma3 vs Gemma4、Qwen3 vs Qwen3.5）的解釋力遠大於參數規模或 tokenizer 選擇。

---

### RQ2：控制語義與句法條件下，繁／簡體中文的 token 計數差異是否為 context rot 加速的獨立因素？

**設計控制**：三 variant 設計提供兩個正交比較：
- **Haystack 腳本效應**（繁問繁答 vs 繁問簡答）：相同問題語言、相同語義內容，僅 haystack 繁/簡不同 → 隔離 token 計數差異的獨立影響
- **問題語言效應**（繁問簡答 vs 簡問簡答）：相同簡體 haystack，問題語言不同 → 量化問題端的貢獻

#### 65K 字元：haystack 腳本效應（繁問繁答 − 繁問簡答，負值表示繁體較差）

| 模型 | 繁問繁答 | 繁問簡答 | 簡問簡答 | Haystack效應 | 問題語言效應 |
|------|---------|---------|---------|------------|------------|
| gemma3:4b | 88.2% | 93.6% | 92.7% | **−5.4pp** | −0.9pp |
| gemma3:12b | 96.4% | 95.5% | 95.5% | +0.9pp | 0pp |
| llama3.1:8b | 92.7% | 94.5% | 96.4% | **−1.8pp** | −1.9pp |
| llama3.1:70b | 100.0% | 100.0% | 100.0% | 0pp | 0pp |
| llama3.3:70b | 97.3% | 96.4% | 98.2% | +0.9pp | −1.8pp |

#### 130K 字元：haystack 腳本效應（Mode B 模型）

| 模型 | 繁問繁答 | 繁問簡答 | 簡問簡答 | Haystack效應 | 問題語言效應 |
|------|---------|---------|---------|------------|------------|
| gemma3:4b | 52.7% | 50.9% | 52.7% | +1.8pp（反轉）| −1.8pp |
| gemma3:12b | 86.4% | 80.9% | 86.4% | +5.5pp（反轉）| −5.5pp |
| llama3.1:8b | 91.8% | 84.5% | 82.7% | +7.3pp（反轉）| +1.8pp |
| llama3.3:70b | 80.9% | 90.0% | 87.3% | **−9.1pp** | +2.7pp |
| llama3.1:70b | 71.8% | 78.2% | 84.5% | **−6.4pp** | **−6.3pp** |

**關鍵觀察**：

1. **效應在中等 context 長度（65K）方向一致**：gemma3:4b 與 llama3.1:8b 均呈現簡體 haystack 優於繁體（−1.8 至 −5.4pp），haystack 腳本效應顯著大於問題語言效應（−0.9 vs −1.9pp）。
2. **效應在極長 context（130K）高度非線性**：gemma3:4b / gemma3:12b / llama3.1:8b 的 haystack 效應在 130K 出現反轉——繁問簡答反而比繁問繁答更差。可能機制：模型在極長 context 下簡體理解有訓練分布劣勢，或問題語言（繁體）與簡體 haystack 的混語效應（code-switching）在超長 context 產生干擾。
3. **Llama 70B 維持方向一致**：llama3.1:70b / llama3.3:70b 在 130K 仍呈現繁體 haystack 劣於簡體（−6.4 至 −9.1pp），且效應幅度大於 8B，表示大模型在此範圍的繁/簡敏感度更強。
4. **問題語言效應小且不穩定**：問題語言（繁問簡答 vs 簡問簡答）的差距在大多數模型和長度下不超過 2pp，且方向不一致，不構成系統性影響。

**RQ2 答覆**：token 計數差異在「脆弱」模型（Mode B）的中等 context 長度（65K）是顯著的獨立加速因子，方向一致支持假說（haystack 腳本效應 −1.8 至 −5.4pp）。然而效應在極長 context（130K）出現非單調性（部分模型反轉），在架構強健模型（Mode D）中完全消失，表示 token overhead 效應是**條件性獨立因子**——其作用以模型脆弱性為前提，並非無條件成立。

---

### 探索性分析：架構、參數量與繁體長 Context 抵抗力

以下為探索性分析（非確認性結論），樣本數不足做統計迴歸，但可觀察趨勢。17 個模型依退化曲線形態歸納為四種行為模式。
...
| llama3.1:70b | 4K–65K | 100.0% | 94.5% | 71.8% |
| llama3.3:70b | 2K–32K（500=99.1%）| 97.3% | 97.3% | 80.9% |

特徵：隨 context 長度增加，準確率單調（或近似單調）下降；退化幅度可量化。這是觀察與研究 context rot 機制的最佳模型類型。llama3.1:8b 曲線略非單調（500 字元起點 94.5%，6K 起回升至 100%，65K 後才開始下降），推測與短 context 下的評估噪音或 Lost-in-the-Beginning 效應有關。llama3.1:70b 的 130K 降幅（−28.2pp，100K→130K）為本系列最大，是研究 70B 級模型繁體 context rot 的關鍵數據點。
...
**探索性結論**：模型世代與架構是繁體長 context 性能的主要預測因子，遠超過參數量。Qwen3.5 全系列與 Gemma4 系列已實質解決 130K 字元以內的繁體中文長 context 問題；Gemma3 系列則隨 context 長度呈現明顯的規模依賴退化。Llama 系列在 70B 規模呈現明顯的 130K 退化（71.8–80.9%），且繁/簡差距大於 8B，顯示大模型在此長度下對 tokenizer overhead 的敏感度反而更高。

---

### RQ3：token overhead 在不同分詞器家族中使 context rot 起始點提前多少 token？

**分析方法**：以各模型的三 variant 實測 token 數（`tokens_trad`、`tokens_simp`），計算繁體與簡體 context 在相同字元長度下的 token 差值（Δtokens）。起始點提前量（token 單位）= 繁問繁答 onset token 數 − 簡問簡答 onset token 數。僅納入模式 B（漸進退化型）且有明確 onset 的模型。

#### 各家族 token overhead 實測值（prompt 層級）

| Tokenizer 家族 | 代表模型 | avg ratio（繁/簡）| Overhead | @65K Δtokens | @100K Δtokens |
|---------------|---------|-----------------|---------|-------------|--------------|
| Gemma3/4 | gemma3:4b | 1.0568 | +5.7% | ~2,700 | ~4,100 |
| Llama | llama3.1:8b | 1.0706 | +7.1% | ~3,850 | ~5,900 |
| Llama | llama3.1:70b | 1.0706 | +7.1% | ~3,850 | ~5,900 |
| Qwen3.5 | qwen3.5:2b–35b | 1.1008 | +10.1% | ~5,500 | ~8,400 |
| Qwen3 | qwen3:8b | 1.1354 | +13.5% | —（硬截斷，排除）| — |

#### Onset 提前量估算（Mode B 模型）

對於相同字元長度的 onset，繁體 context 比簡體 context 多消耗的 token 數即為「起始點提前量」：

| 模型 | trad onset（chars）| trad onset（tokens）| simp_q @same chars（tokens）| 提前量（tokens）|
|------|--------------------|--------------------|-----------------------------|----------------|
| gemma3:4b | ~65K | ~49,300 | ~46,400 | **~2,900 tokens（+6.3%）** |
| llama3.1:8b | ~65K | ~57,250 | ~53,400 | **~3,850 tokens（+7.2%）** |
| llama3.1:70b | ~100K | ~70,600 | ~65,900 | **~4,700 tokens（+7.1%）** |
| llama3.3:70b | ~100K | ~70,600 | ~65,900 | **~4,700 tokens（+7.1%）** |

→ 提前量比例（Δtokens / onset_tokens）與各家族的 tokenizer overhead 幾乎吻合（Gemma +5.7%→+6.3%，Llama +7.1%→+7.1–7.2%），驗證「onset 提前量 ≈ overhead 比例 × onset token 數」的線性關係。

**Qwen3.5 的反例**：儘管 Qwen3.5 的 overhead 最高（+10.1%，Δtokens @65K ≈ 5,500），其所有模型均未出現 onset，無法計算提前量。原因是模型本身對此長度範圍的 context rot 完全免疫（模式 D），overhead 效應被架構吸收。

**RQ3 答覆**：在呈現漸進退化的模型（Mode B）中，繁體書寫系統造成的 token overhead 使 context rot 起始點提前約 **overhead 比例 × onset token 數** 個 token（Gemma3 家族提前 ~2,900 tokens，Llama 家族提前 ~3,850–4,700 tokens）。此提前量與各家族 tokenizer overhead 線性對應，可作為估算不同語言在相同模型上的有效 context 容量縮減量。**重要邊界條件**：此估算僅在模型處於脆弱（Mode B）狀態下成立；架構強健的模型（Mode D）即使 overhead 更高，onset 提前量仍為零。
...
1. **架構世代是壓倒性的主因（RQ1）**：Qwen3.5（最高 overhead +10.1%）與 Gemma4 完全免疫；架構升級（gemma3:4b → gemma4:e2b）提升 47pp @130K，遠大於繁/簡差異（1.8–5.4pp）。控制架構後，tokenizer 家族無獨立預測力；參數規模影響退化速率而非起始點。

2. **Token 計數差異是條件性獨立加速因子（RQ2）**：在脆弱模型（Mode B）的中等 context 長度（65K），haystack 腳本效應方向一致（−1.8 至 −5.4pp，繁體較差）；問題語言效應小而不穩定（≤2pp）。效應在極長 context（130K）出現非單調反轉，在強健模型（Mode D）中完全消失。

3. **Onset 提前量與 overhead 線性對應（RQ3）**：Mode B 模型中，繁體 context rot onset 比簡體早 overhead 比例 × onset_token 數個 token（Gemma3 家族 ~2,900 tokens，Llama 家族 ~3,850–4,700 tokens）。此線性關係在 Mode D 模型中因架構免疫而消失。

4. **效應在極長 context 下非單調**：gemma3:4b 在 100K/130K 繁/簡差距歸零；多個 Llama 模型在 130K 出現反轉或方向不一致；token overhead 效應不在所有 context 長度線性累積。

5. **70B 規模的 Llama 模型比 8B 對 overhead 更敏感（新發現）**：llama3.1:70b @130K 繁問繁答 71.8%，繁/簡差距 12.7pp，明顯大於 llama3.1:8b 的差距（−0pp 到 +9.1pp），推測超長 context 下大模型的 attention 稀釋效應與 token overhead 產生正向交互。

6. **模型行為模式分類（四類）**：硬性上限型（A）、漸進退化型（B）、突發崩潰型（C）、近乎完美型（D），有助於研究者選擇適合模型作為研究工具或部署決策。

#### 未建立的項目

- **Overhead-Performance 定量因果**：雖然 Mode B 模型的 onset 提前量與 overhead 線性對應，但 Qwen3.5 的反例（overhead 最高卻無 rot）表明 overhead 是充分條件而非必要條件；架構免疫可完全抵消。
- **130K 反轉機制**：gemma3:4b / gemma3:12b / llama3.1:8b 在 130K 出現「繁問簡答 < 繁問繁答」反轉，機制未解（訓練分布偏差？混語干擾？）。
- **Qwen3.5 / Gemma4 的真實臨界點**：天花板效應使本實驗設計對這些模型失效，需要 200K+ 字元實驗。

#### 研究局限

- **天花板效應**：現代高性能模型在 130K 字元以內幾乎完美，限制了對前沿模型的評估能力。
- **資料品質問題**：gemma3:27b 的 pad token bug 使其 100K/130K 資料不可信。
- **Tokenizer Overhead 量測**：overhead 為語料級平均，未測量句段級方差。
- **Distractor 污染**：N04（台灣黑熊）的絕對準確率受干擾偏低，不代表模型能力（但 variant 相對比較有效）。

#### 未來工作建議

**優先：**

1. **調查 130K 反轉現象的機制**——多個 Llama / Gemma3 模型的 130K 繁問簡答 < 繁問繁答，方向違反假說，需確認是統計噪音（僅 110 筆/長度）還是系統性效應。
2. **擴充至 Gemma4 / Qwen3.5，使用 200K+ 字元**——克服天花板效應，取得 RQ3 在更多家族的 onset 提前量數據。

**中期：**

3. **英文 baseline 實驗**：建立模型長 context 能力的理論上限參考（附錄用，不用於驗證 overhead 假說）。
4. **句段級 tokenizer overhead 量化**：對 haystack 語料直接測量，取代語料級平均值。
5. **修復實驗設計缺陷**：加入 distractor detection、sanity probe、token count check，寫入 v2 腳本。
6. **控制詞彙實驗**：使用字詞一對一轉換的繁簡版本，消除語義混淆，更純粹地測試 tokenizer 效應。
...
| 章節 | 內容 | 資料狀態 |
|------|------|---------|
| Ch.1 引言 | 繁體中文 tokenizer 碎片化問題、研究動機 | ✅ 已有 |
| Ch.2 文獻回顧 | NIAH 方法論、context rot 定義（onset vs rate）、tokenizer 碎片化 | ✅ 已有 |
| Ch.3 研究方法 | 三 variant 設計、reeval 邏輯、token overhead 實測（字元級 vs prompt 級 5.7–13.5%） | ✅ 已有 |
| Ch.4.1 RQ1 | 控制架構後，tokenizer 家族與參數規模對 onset/rate 的相對解釋力 | ✅ 完整（17 模型三 variant） |
| Ch.4.2 RQ2 | 控制語義/句法條件，token 計數差異是否為獨立加速因子 | ✅ 完整（17 模型三 variant；65K 效應成立，130K 非單調）|
| Ch.4.3 RQ3 | token overhead 在各 tokenizer 家族使 onset 提前多少 token | ✅ Mode B 模型線性對應（Gemma ~2.9K tokens，Llama ~3.9–4.7K tokens）|
| Ch.4.4 探索性分析 | 行為模式分類（A–D）、架構世代 vs 參數規模、宣稱 vs 實際 ctx | ✅ 17 模型全三 variant |
| Ch.5 討論 | token 碎片化雙效應不可分離、latent pivot、70B 敏感度異常、130K 反轉機制 | ✅ 定性論述（含新發現）|
| Ch.6 結論 | RQ1–3 答覆、條件性獨立因子框架、架構免疫機制 | ✅ |
| 附錄 | 17 模型完整退化曲線、熱力圖、模型適用性矩陣 | ✅ 已有 |

#### Token 碎片化的理論定位（Ch.5 討論章節）

Token 碎片化造成兩個不可分離的效應：

1. **Token 數量增加**：相同語意內容佔用更多 context window 容量
2. **語意密度降低**：每個 token 承載的平均語意資訊量下降

兩個效應在現有實驗設計下無法完全分離（需要控制 token 數量而改變語意密度，或反之），適合放在討論章節作為機制層面的詮釋，不作為獨立的可測變數。

#### 英語樞紐機制（Latent Pivot，Ch.5 討論章節）

多語言 LLM 可能在中間層以英語語意空間進行推論（latent pivot hypothesis）。此機制與 thinking mode 無關（關閉 thinking 不影響中間層行為），可能部分抵消 token 膨脹效應——若模型內部以英語處理，則輸入端的繁/簡差異在中間層被語意壓縮。此為無法排除的干擾因素，適合在討論章節作為理論限制陳述。

#### 不納入本論文的議題

以下議題與本研究相關但超出範圍，列為未來研究方向：

- Embedding 模型品質比較（繁/簡對語意向量的影響）
- RAG chunking 設計（繁體 token 膨脹對 chunk 大小的影響）
- 語意向量品質量測（繁/簡文本在 embedding 空間的距離差異）
